      ...
      <section className="relative py-20 md:py-32 bg-gradient-to-b from-[#1a1a1a] to-[#0a0a0a] overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 md:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
            <a href="tel:+18886202103" className="px-10 py-4 bg-[#d4af37] text-black font-bold text-lg rounded-lg hover:bg-[#c9a532] transition-all duration-300 transform hover:scale-105 shadow-xl">
              Call Now: (888) 620-2103
            </a>
            <a href="tel:+18886202103" className="px-10 py-4 border-2 border-[#d4af37] text-[#d4af37] font-semibold text-lg rounded-lg hover:bg-[#d4af37]/10 transition-all duration-300">
              Call Now: (888) 620-2103
            </a>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                <li>
                  <a href="tel:+18886202103" className="hover:text-[#d4af37] transition-colors">
                    📞 (888) 620-2103
                  </a>
                </li>
                <li>
